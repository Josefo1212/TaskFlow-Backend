...
const envSchema = z.object({
	...
	USER_GRPC_URL: z.string().min(1, 'USER_GRPC_URL is required'),
	TASK_GRPC_URL: z.string().min(1, 'TASK_GRPC_URL is required'),
	PROJECT_GRPC_URL: z.string().min(1, 'PROJECT_GRPC_URL is required'),
	TAG_GRPC_URL: z.string().min(1, 'TAG_GRPC_URL is required'),

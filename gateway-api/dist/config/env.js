...
const envSchema = zod_1.z.object({
    ...
    AUTH_GRPC_URL: zod_1.z.string().min(1, 'AUTH_GRPC_URL es requerido.'),
    USER_GRPC_URL: zod_1.z.string().min(1, 'USER_GRPC_URL es requerido.'),
    TASK_GRPC_URL: zod_1.z.string().min(1, 'TASK_GRPC_URL es requerido.'),
    PROJECT_GRPC_URL: zod_1.z.string().min(1, 'PROJECT_GRPC_URL es requerido.'),
    TAG_GRPC_URL: zod_1.z.string().min(1, 'TAG_GRPC_URL es requerido.'),

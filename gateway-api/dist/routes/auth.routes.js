...
router.post('/forgot-password', rate_limit_middleware_1.authRateLimiter, (0, async_handler_1.asyncHandler)(auth_controller_1.forgotPasswordController));
router.post('/reset-password', rate_limit_middleware_1.authRateLimiter, (0, async_handler_1.asyncHandler)(auth_controller_1.resetPasswordController));
